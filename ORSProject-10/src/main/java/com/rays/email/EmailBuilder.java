 ...
 * for different user-related actions such as registration, password recovery,
 * and password change.
 * 
 * It builds dynamic email messages using user data provided in a HashMap.
 * 
 * Keys expected in map:
 * - firstName
 * - lastName
 * - login
 * - password
...
public class EmailBuilder {
     ...
     * 
     * @param map contains user details
